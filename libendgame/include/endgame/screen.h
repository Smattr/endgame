 ...
 */
ENDGAME_API int eg_screen_init(void);

/// get the number of columns in the terminal
ENDGAME_API size_t eg_screen_get_columns(void);

/// get the number of rows in the terminal
ENDGAME_API size_t eg_screen_get_rows(void);

ENDGAME_API int eg_screen_put(size_t x, size_t y, const char *text, size_t len);

ENDGAME_API void eg_screen_sync(void);
 ...
 * \return Event seen
 */
ENDGAME_API eg_event_t eg_screen_read(void);

/// blank the screen, clearing all text
ENDGAME_API void eg_screen_clear(void);
 ...
 */
ENDGAME_API void eg_screen_free(void);
